...
import { Thermometer, FileText, X, Upload, Loader2, AlertTriangle } from "lucide-react";
import NeumorphicCard from "../neumorphic/NeumorphicCard";
import NeumorphicButton from "../neumorphic/NeumorphicButton";
import moment from "moment";

export default function MalattiaView({
  malattiaForm, setMalattiaForm,
  turniFuturi, currentUser,
  richiestaMalattiaMutation,
  mieMalattie,
  handleUploadCertificato,
  uploadingCertificato,
  uploadingCertificatoForId, setUploadingCertificatoForId,
      ...
      <NeumorphicCard className="p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div>
            ...
            <input type="date" value={malattiaForm.data_inizio}
          ...
          <div>
            ...
            <input type="date" value={malattiaForm.data_fine}
          ...
          <div>
            ...
            <input type="text" value={malattiaForm.descrizione}
        ...
        <div className="p-3 bg-orange-50 rounded-xl mt-4 space-y-2">
          ...
          <p className="text-sm text-red-600 font-medium">📋 Hai 5 giorni dall'ultimo giorno di malattia per caricare il certificato medico. Dopo tale data l'assenza verrà considerata non giustificata.</p>
        </div>
        <NeumorphicButton
                          ...
                          {isScaduto ? (
                            <div className="p-2 bg-red-100 rounded-lg mb-2">
                              <p className="text-xs text-red-700 font-medium flex items-center gap-1">
                                <AlertTriangle className="w-3 h-3" /> Scadenza superata - Assenza non giustificata
                              </p>
                            </div>
                          ) : giorniRimanenti <= 5 && (
                            <div className="p-2 bg-orange-100 rounded-lg mb-2">
                              <p className="text-xs text-orange-700 font-medium flex items-center gap-1">
                                ...
                                {giorniRimanenti === 0 ? 'Scade oggi!' : `Scade tra ${giorniRimanenti} giorn${giorniRimanenti === 1 ? 'o' : 'i'}`}
                              </p>
