...
export default function DisponibilitaView({ currentUser, mieDisponibilita }) {
  return (
    <>
      ...
      <div className="flex gap-2">
        <NeumorphicButton variant="primary" className="flex-1">Vista Calendario</NeumorphicButton>
      </div>
