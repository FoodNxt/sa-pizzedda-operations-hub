      ...
      try {
        ...
        if (normalizedUserType === 'admin') {
          ...
          if (!allowedPages.includes(pageName)) {
            ...
            const adminPages = ['Dashboard', 'Presenze', 'SummaryAI', 'FormTracker', 'Pulizie', 'PulizieMatch', 'FormPulizia', 'Attrezzature', 'Employees', 'Shifts', 'StoreReviews', 'Financials', 'VenditeAnalytics', 'UsersManagement', 'ATS', 'StoreManagerAdmin', 'Planday', 'GestioneAssistente', 'ValutazioneProvaForm', 'StrutturaTurno', 'Compliance', 'Documenti', 'FeedbackP2P', 'Inventory', 'MateriePrime', 'ElencoFornitori', 'ConfrontoListini', 'AnalisiSprechi', 'StoricoImpasti', 'PrecottureAdmin', 'InventarioAdmin', 'InventarioStoreManager', 'GestioneAccessoPagine', 'FunzionamentoApp', 'Alerts', 'OverviewContratti', 'RealTime', 'ChannelComparison', 'StoricoCassa', 'OrdiniSbagliati', 'MatchingOrdiniSbagliati', 'ProdottiVenduti', 'AcademyAdmin', 'Assenze', 'InventoryForms', 'FinancialForms', 'AssignReviews', 'EmployeeReviewsPerformance', 'Payroll', 'Segnalazioni', 'Pause', 'FormInventario', 'FormCantina', 'Impasto', 'Preparazioni', 'Precotture', 'ControlloPuliziaCassiere', 'ControlloPuliziaPizzaiolo', 'ControlloPuliziaStoreManager'];
          ...
          if (!allowedPages.includes(pageName)) {
            const managerPages = ['Dashboard', 'Presenze', 'SummaryAI', 'FormTracker', 'Pulizie', 'PulizieMatch', 'FormPulizia', 'Attrezzature', 'Employees', 'Shifts', 'StoreReviews', 'Financials', 'VenditeAnalytics', 'ATS', 'StoreManagerAdmin', 'Planday', 'ValutazioneProvaForm', 'StrutturaTurno', 'Compliance', 'Documenti', 'FeedbackP2P', 'Inventory', 'MateriePrime', 'ConfrontoListini', 'Alerts', 'OverviewContratti', 'InventarioStoreManager', 'AssignReviews', 'EmployeeReviewsPerformance', 'Segnalazioni', 'Pause', 'FormInventario', 'FormCantina', 'Impasto', 'Preparazioni', 'Precotture', 'ControlloPuliziaCassiere', 'ControlloPuliziaPizzaiolo', 'ControlloPuliziaStoreManager'];
