    ...
    <div className="max-w-7xl mx-auto space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <NeumorphicCard className="p-6 text-center">
          ...
          <p className="text-sm text-[#9b9b9b]">Fornitori</p>
        </NeumorphicCard>
      </div>
          ...
          <NeumorphicCard className="max-w-2xl w-full max-h-[90vh] overflow-y-auto p-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  <label className="text-sm font-medium text-[#6b6b6b] mb-2 block">
                    Quantità Minima <span className="text-red-600">*</span>
                  </label>
                  <input
                    type="number"
                    step="0.01"
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b-2 border-[#8b7355]">
                    ...
                    <th className="text-right p-3 text-[#9b9b9b] font-medium">Qtà Minima</th>
