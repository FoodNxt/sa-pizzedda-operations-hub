...
import { ShoppingCart, Copy, CheckCircle, AlertCircle, FileSpreadsheet, Key } from 'lucide-react';
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <ul className="space-y-1 text-[#6b6b6b]">
                  ...
                  <li>• <strong>Spreadsheet:</strong> Il tuo Google Sheet con gli ordini</li>
                </ul>
              </div>
            </div>
          </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <div className="neumorphic-pressed p-4 rounded-lg bg-red-50 mb-4">
                  <p className="font-bold text-red-700 mb-2">⚠️ Campi OBBLIGATORI:</p>
      ...
      <NeumorphicCard className="p-6">
        ...
        <div className="neumorphic-pressed p-4 rounded-xl mb-4">
          <p className="text-[#6b6b6b] mb-3">
            Il Google Sheet deve avere le seguenti colonne (minimo obbligatorio):
          </p>
        ...
        <div className="neumorphic-flat p-4 rounded-xl">
          <p className="text-sm text-[#6b6b6b] mb-2">
            💡 <strong>Nota:</strong> Le colonne possono avere esattamente i nomi indicati nella struttura OrderItem entity
          </p>
          <p className="text-sm text-[#6b6b6b]">
            📊 Puoi esportare i dati dal tuo sistema POS e caricarli su Google Sheets per l'import automatico
          </p>
        </div>
      </NeumorphicCard>
    </div>
