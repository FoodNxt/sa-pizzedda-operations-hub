...
import {
  ...
  ArrowRightLeft, Check, AlertTriangle, CheckCircle, MapPin } from
"lucide-react";
    ...
    <ProtectedPage pageName="PlandayStoreManager">
      <div className="max-w-full mx-auto space-y-4">
        ...
        <div className="flex items-center justify-between flex-wrap gap-4">
          <div>
            <h1 className="bg-clip-text text-slate-50 text-3xl font-bold from-slate-700 to-slate-900">Planday Store Manager

            </h1>
            <p className="text-slate-50 mt-1">Gestione turni per i tuoi store</p>
          </div>
