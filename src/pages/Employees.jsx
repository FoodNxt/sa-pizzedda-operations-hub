...
export default function Employees() {
  ...
  const employeeMetrics = useMemo(() => {
    ...
    return users.map((user) => {
      ...
      // Pulizie: use pre-computed cleaningScoreMap
      const cleaningData = cleaningScoreMap.get(employeeName);
      if (cleaningData && cleaningData.count > 0 && cleaningData.percentualePulito < 80) {
        const cleaningPenalty = (80 - cleaningData.percentualePulito) * w_pulizie * 0.1;
