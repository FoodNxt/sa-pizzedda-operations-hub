...
import { 
  ...
  User, Store, Trash2, Edit, Settings, Loader2
} from "lucide-react";
  ...
  React.useEffect(() => {
    if (config) {
      setConfigForm({
        ...
        tolleranza_ritardo_minuti: config.tolleranza_ritardo_minuti || 5,
                  ...
                  <div key={hour} className="grid grid-cols-8 gap-1">
                    ...
                    {weekDays.map(day => {
                      ...
                      return (
                        <div 
                          key={`${dayKey}-${hour}`}
                          className="min-h-[50px] neumorphic-pressed rounded-lg p-1 cursor-pointer hover:bg-slate-50"
                          onClick={() => hourTurni.length === 0 && handleCellClick(day, hour)}
                        >
                          {hourTurni.map(turno => (
                            <div 
                              key={turno.id}
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setConfigForm({ ...configForm, tolleranza_ritardo_minuti: parseInt(e.target.value) || 5 })}
                    className="w-full neumorphic-pressed px-4 py-3 rounded-xl text-slate-700 outline-none"
                  />
                </div>
